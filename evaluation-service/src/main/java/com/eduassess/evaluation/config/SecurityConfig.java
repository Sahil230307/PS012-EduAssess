package com.eduassess.evaluation.config;
import com.eduassess.security.*;
...
public class SecurityConfig {
 @Bean JwtService jwtService(@Value("${security.jwt.secret}") String secret,@Value("${security.jwt.expiration-ms}") long exp){return new JwtService(secret,exp);}
